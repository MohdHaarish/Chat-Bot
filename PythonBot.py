...
from bot import chat        # Python's chatbot login file name which has the function to take user input and process
                            # it.  bot is file name and chat is function name
...
class ChatInterface(Frame):
    ...
    def about(self):
        tkinter.messagebox.showinfo("PyBOT Developers", "Mohd Haarish")
